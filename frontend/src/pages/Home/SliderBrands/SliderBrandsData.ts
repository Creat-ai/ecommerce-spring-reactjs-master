...
export const brandsItem: Array<BrandType> = [
    { name: "Krauf", url: "https://krauf.ru/assets/images/main/krauf.svg" },
    { name: "Ravenol", url: "https://www.ravenol.de/storage/app/uploads/public/d2a/229/9ba/thumb__0_0_0_0_auto.png" },
    { name: "Bosh", url: "https://www.boschautoparts.com/o/bosch-autoparts-theme/images/bosch-logo.svg" },
